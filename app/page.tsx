...
const HomePage = () => {
  const { onlineUsers, onlineUsersCount, votes, sendJsonMessage, readyState } = useHome()
...
export default function Home() {
  return (
    <WebSocketProvider socketUrl={`${process.env.NEXT_PUBLIC_SERVER_URL}:${process.env.NEXT_PUBLIC_SERVER_PORT}`}>
      <HomePage />
    </WebSocketProvider>
  )
}
